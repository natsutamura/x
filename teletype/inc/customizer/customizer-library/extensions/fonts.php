...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'teletype' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'teletype' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'teletype' ),
		'cyrillic'     => __( 'Cyrillic', 'teletype' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'teletype' ),
		'devanagari'   => __( 'Devanagari', 'teletype' ),
		'greek'        => __( 'Greek', 'teletype' ),
		'greek-ext'    => __( 'Greek Extended', 'teletype' ),
		'khmer'        => __( 'Khmer', 'teletype' ),
		'latin'        => __( 'Latin', 'teletype' ),
		'latin-ext'    => __( 'Latin Extended', 'teletype' ),
		'vietnamese'   => __( 'Vietnamese', 'teletype' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'opensans' => array(
			'label' => _x( 'Open Sans', 'font style', 'teletype' ),
			'stack' => '"Open Sans", Helvetica, Arial, sans-serif'
		),
		'verdana' => array(
			'label' => _x( 'Verdana', 'font style', 'teletype' ),
			'stack' => 'Verdana, Geneva, sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'teletype' ),
