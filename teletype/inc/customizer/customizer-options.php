...
function teletype_customizer_library_options() {
	...
	$options['headline-size'] = array(
		...
		'description' => esc_html__( 'Note this: If it is custom text in the Headline section, it must be enclosed in the <h1> tag', 'teletype' ),
		'section' => $section,
		'type'    => 'range',
		'input_attrs' => array(
	        'min'   => 18,
	...
	$sections[] = array(
		...
		'description' => esc_html__( 'The sidebar is on the right by default. If there are no widgets in the sidebar, it is not displayed.', 'teletype' ),
		'priority' => '160'
	);
