...
class Teletype_Welcome_Screen {
	...
	public function register_menu_page() {
		 add_theme_page( esc_html__( 'Teletype Dashboard', 'teletype' ), esc_html__( 'Theme Info', 'teletype' ), 'edit_theme_options', 'teletype-dashboard', array( self::$instance, 'theme_dashboard_page' ) );
	}
